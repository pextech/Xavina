...
if (isset($_GET['i'])) {
 ...
 $stmt = $DB_con->prepare("SELECT * FROM supplier WHERE id='$barcode'");
  $stmt->execute();
...
$sql = "UPDATE order_status SET customer='$p_barcode'WHERE stock_status='in' AND sale_status='pending' AND order_id='$invoice' ";
