            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Stock Requestion</li>
                    </ul>
                     <br>
                    <div class="col-md-12">
                       ...
                       <button class="btn btn-sm btn-success" ><a href="#" data-toggle="modal" data-target="#Purchase "><font color="white"><b> Display Order </b></font></a></button>
   </div>
     ...
     <!-- Multi Column -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Purchase</strong> basket</h2>
