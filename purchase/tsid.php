...
<center>  ---------------------------------------------------</center>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            ...
                            $check = "SELECT customer FROM purchase where stock_status='out' and sale_status='pending' AND order_id='$invoice'";
 ...
 <button class="btn btn-sm btn-success" ><a href="#" data-toggle="modal" data-target="#Supplier"><font color="white"><b> New Supplier </b></font></a></button>
  ...
  <div  role="alert" >
          <input type="text" onkeyup="showcustomer(this.value)" class="form-control" style="color: black;" placeholder="search by Name Or Phone " aria-describedby="basic-addon2" id="Supplierned">
