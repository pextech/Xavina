...
$jax = mysqli_query($conn,"SELECT * FROM `adjust` WHERE order_id='$invoice' AND sale_status='$statuso'");
...
$upd=mysqli_query($conn,"UPDATE adjust SET sale_status='$status' WHERE order_id='$invoice' AND sale_status='$statuso'");
