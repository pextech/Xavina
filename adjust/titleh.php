            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                     ...
                     <br>
                    <div class="col-md-2">
                        <button class="btn btn-sm btn-success" ><a href="../invoice/Inventoryex.php" target="_blank"><font color="white"><b> Export Excel</b> </font></a></button>
   </div>
     ...
     <!-- Multi Column -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>adjustment</strong> basket</h2>
