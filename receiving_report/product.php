    ...
    <div class="body_scroll">
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="body">
                           <h5 style="background-color: blue;color: white;border-radius: 2px;padding: 5px;"><center><b><?php echo $order_status; ?>  Receiving Report as of <?php echo date("M d, Y",strtotime($from_date))." to ".date("M d, Y",strtotime($to_date));?></b></center></h5>
      ...
      <th bgcolor="orange" color="white">barcode</th>
                   ...
                   <th bgcolor="orange" color="white">total</th>
                                        ...
                                        <?php
  $result ="SELECT * FROM order_status WHERE item='$order_status' AND stock_status='$status'  AND sale_status='ordered' AND done_date  BETWEEN '" . $from_date . "' AND  '" . $to_date . "'";
...
while($row = mysqli_fetch_array($new)) { 
  extract($row);
                 ...
                 <td><?php echo  number_format($total); ?>  </td>
                                            ...
                                            <?php } ?>
                      <?php
$re= mysqli_query($conn,"SELECT sum(total) FROM order_status WHERE item='$order_status' AND sale_status='ordered' AND stock_status='$status'  AND done_date  BETWEEN '" . $from_date . "' AND  '" . $to_date . "'");
