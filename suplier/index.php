        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <br>
                    <div class="col-md-2">
     <button class="btn btn-sm btn-success" ><a href="#" data-toggle="modal" data-target="#Supplier"> New Supplier</a></button>
   </div>
                </div>
...
include("../config/index.php");
  $stmt = $DB_con->prepare('SELECT * FROM supplier ORDER BY id');
  $stmt->execute();
    ...
    ?>
        ...
        <div class="col-xs-12">
          <div class="alert alert-warning">
              <span class="glyphicon glyphicon-info-sign"></span> &nbsp; No supplier Found ...
            </div>
        </div>
        <?php
  }
