...
extract($row);
     ...
     include("../../../config/index.php");
      $stmt_edit = $DB_con->prepare("select sum(total) as totalx from order_status  WHERE done_date BETWEEN '" . $from_date . "' AND  '" . $to_date . "' AND item='$order_status' AND sale_status='$sale'");
         $id=$row['id'];
