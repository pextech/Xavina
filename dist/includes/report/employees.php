          ...
          <tr>
                  ...
                  <th bgcolor="orange" color="white">order_id</th>
                   ...
                   <th bgcolor="orange" color="white">total</th>
                     ...
                     <tbody>
                      <?php
  $result ="SELECT * FROM order_status WHERE done='$order_status' AND sale_status='ordered' AND done_date  BETWEEN '" . $from_date . "' AND  '" . $to_date . "'";
...
while($row = mysqli_fetch_array($new)) { 
  extract($row);
                 ...
                 <td><?php echo  number_format($total); ?>  </td>
                      ...
                      <?php } ?>
                      <?php
$re= mysqli_query($conn,"SELECT sum(total) FROM order_status WHERE done='$order_status' AND sale_status='ordered' AND done_date  BETWEEN '" . $from_date . "' AND  '" . $to_date . "'");
