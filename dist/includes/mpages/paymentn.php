...
include('../dbcon.php');
 ...
 mysqli_query($conn,"INSERT INTO payment
		...
		VALUES
		('$insurances','$ins_pya','$invoiceq','$cst_pay','$payte','$statuso','$done')")
...
$upd=mysqli_query($conn,"UPDATE order_status SET sale_status='$status' WHERE order_id='$invoiceq'");
...
$upinv=mysqli_query($conn,"UPDATE invoice SET status='$status' WHERE order_id='$invoiceq'");
