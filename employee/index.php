        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <br>
                    <div class="col-md-2">
     <button class="btn btn-sm btn-success" ><a href="#" data-toggle="modal" data-target="#employee"> New Employees</a></button>
   </div>
                </div>
  ...
  if($stmt->rowCount() > 0)
  {
    while($row=$stmt->fetch(PDO::FETCH_ASSOC))
    {
      ...
      ?>
          ...
          <td><?= $nid ; ?></td>
          <td><?php
          $query=mysqli_query($conn,"select * from branch where branch_id='$id'")or die(mysqli_error($conn));
  $branch_retr=mysqli_fetch_array($query); 
          echo 
          $branch_retr['branch_name']; ; 
          ?></td>
          <td><a class="btn btn-info" href="#" data-toggle="modal" data-target="#Supplierup<?php echo $id; ?>"><div class="icon-circle bg-green"><i class="zmdi zmdi-edit"></i></div></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="?delete_id=<?php echo $id ?>" title="click for delete" onclick="return confirm('Are you sure to remove <?php echo $fullname; ?>?')"><div class="icon-circle bg-red"><i class="zmdi zmdi-delete"></i></div></a></td>
          <?php include '../update/employee.php'; ?>
                                        </tr>
                                       <?php
    }
    ...
    ?>
        ...
        <div class="col-xs-12">
          <div class="alert alert-warning">
              <span class="glyphicon glyphicon-info-sign"></span> &nbsp; No Employee Found ...
            </div>
        </div>
        <?php
  }
