...
$upd=mysqli_query($conn,"UPDATE order_status SET sale_status='unpaid' WHERE order_id='$invoice' AND sale_status='$statuso'");
...
$upinv=mysqli_query($conn,"UPDATE invoice SET status='unpaid' WHERE order_id='$invoice'");
